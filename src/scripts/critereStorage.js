 ...
 */
export const getCriteriaForUser = (username) => {
    if (!username || username === 'Se connecter') {
        return [];
    }
    const allCriteria = getAllUserCriteria();
 ...
 */
export const saveCriteriaForUser = (username, criteria) => {
    if (!username || username === 'Se connecter') {
